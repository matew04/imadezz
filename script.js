...
let songs = [
...

    {
        ...
        videoBgSrc: "videos/some.mp4",
        lyrics: [
            { time: 16, text: "I've been too busy ignoring and hiding" },
            { time: 23, text: "About what my heart actually say" },
            { time: 31, text: "Stay awake while I'm drowning on my thoughts" },
            { time: 40, text: "Sometimes a happiness is just a happiness" },
            { time: 49, text: "I've never been enjoying my serenity" },
            { time: 57, text: "Even if I've got a lot of company" },
            { time: 64, text: "That makes me happy" },
    ...
    },
    {
        ...
        albumArtUrl: "https://i.scdn.co/image/ab67616d0000b273ec5c5ec0da8942e4b03254f3",
        audioSrc: "audio/wel.mp3",
        videoBgSrc: "videos/wellwell.mp4",
        lyrics: [
            { time: 0, text: "Through it all once again, came to know my only friend" },
            { time: 7, text: "Lost control, can't begin, I seek within" },
            { time: 18, text: "To feel the warmth brought within your skin" },
            { time: 22, text: "Did you know, for how it seemed" },
            { time: 32, text: "I should've stayed and let you be" },
            { time: 38, text: "Run into my heart so carelessly" },
            { time: 45, text: "That's the reason I'm afraid" },
            { time: 53, text: "You're thoughts that can't be tamed" },
            { time: 55, text: "And I'm trying to be sane" },
            { time: 57, text: "And I'm trying to be sane" },
            { time: 59, text: "And I'm trying to be sane" }
        ]
    },
